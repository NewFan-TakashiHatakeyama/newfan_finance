...
const NewsArticleWidget = () => {
  ...
  return (
    <div className="bg-light-secondary dark:bg-dark-secondary rounded-2xl border border-light-200 dark:border-dark-200 shadow-sm shadow-light-200/10 dark:shadow-black/25 flex flex-row items-stretch w-full h-32 p-0 overflow-hidden">
      {loading ? (
        ...
        >
          ...
          <div className="flex flex-col justify-center flex-1 px-3 py-2">
            ...
            <p className="text-black/60 dark:text-white/60 text-[10px] leading-relaxed line-clamp-3">
              {article.content}
            </p>
          </div>
        </a>
