      ...
      <div className="flex flex-col pt-4">
        <div className="flex items-center space-x-2">
          ...
          <div className="flex flex-row space-x-0.5 items-center">
            ...
            <h1 className="text-3xl font-medium p-2">{t('settings')}</h1>
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        config && (
          <div className="flex flex-col space-y-6 pb-28 lg:pb-8">
            ...
            <SettingsSection title={t('automaticSearch')}>
              <div className="flex flex-col space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-black/60 dark:text-white/60 mt-0.5">
                        {t('automaticImageSearchDescription')}
                      </p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-3 bg-light-secondary dark:bg-dark-secondary rounded-lg hover:bg-light-200 dark:hover:bg-dark-200 transition-colors">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm text-black/90 dark:text-white/90 font-medium">
                        {t('automaticVideoSearch')}
                      </p>
                      <p className="text-xs text-black/60 dark:text-white/60 mt-0.5">
                        {t('automaticVideoSearchDescription')}
                      </p>
                    </div>
                  </div>
                  <Switch
            ...
            <SettingsSection title={t('systemInstructions')}>
              <div className="flex flex-col space-y-4">
                <Textarea
            ...
            <SettingsSection title={t('modelSettings')}>
              ...
              {selectedChatModelProvider &&
                selectedChatModelProvider === 'custom_openai' && (
                  <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex flex-col space-y-1">
                      <p className="text-black/70 dark:text-white/70 text-sm">
                        {t('customOpenaiBaseUrl')}
                      </p>
                      <Input
                        type="text"
                        placeholder={t('customOpenaiBaseUrl')}
            ...
            <SettingsSection title={t('lemonade')}>
